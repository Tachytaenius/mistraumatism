		...
		if entity.entityType == "creature" and not entity.dead then
			if entity.shootInfo and entity.heldItem and entity.heldItem.itemType.isGun then
				...
				for _= 1, gunType.bulletCount or 1 do
					...
					if not (entity.shootInfo.targetX == entity.x and entity.shootInfo.targetY == entity.y) and gunType.bulletSpread then
						local deltaX, deltaY = entity.shootInfo.targetX - entity.x, entity.shootInfo.targetY - entity.y
